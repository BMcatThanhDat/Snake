...
void diemcaoo()
{
    ...
    ofstream fo("highscore.out");
    fo<<diemcao;
    cout<<diemcao;
    fo.close();
    gotoxy(0,chieurong+5);
    cout<<"Highscore="<<diemcao;
}
